...
export function RoomCard({
  ...
  return items?.map((item) => (
    <article
      key={item}
      className={clsx(
        `relative bg-[var(--card)]  flex flex-col gap-4 rounded-lg shadow-md ring-1 ring-[var(--card)] ring-offset-4 ring-offset-background ml-4`,
        flexBasis
      )}
    >
      ...
      <div>
        <div className="flex items-center justify-start gap-2 p-2 pt-0">
